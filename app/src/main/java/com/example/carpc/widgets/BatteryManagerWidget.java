...
public class BatteryManagerWidget extends Fragment {
    ...
    public void updateParameters(Double voltage, Double current, Double capacity, String maxCell, String minCell) {
        ...
        String[] maxCellVal = maxCell.split(":");
        String[] minCellVal = minCell.split(":");
